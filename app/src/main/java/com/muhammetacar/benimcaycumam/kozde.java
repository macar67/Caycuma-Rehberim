...
public class kozde extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng timya = new LatLng(41.425875, 32.0739503);
        mMap.addMarker(new MarkerOptions().position(timya).title("CAFE TİMYA"));
